...
object {roughgappywall (<5, 0.4, 0.1>, 0.01, 5, 0.01, 0.3, 10, 3) translate -1.3*z}

camera { location <0, 4, -3> look_at <0, 0, 0> }

camera { location <2, 2, -2> look_at <1, 1, 0> }  // cylinder
camera { location <0, 3, -2> look_at <0, 1, 0> }  // box
camera { location <-1.5, 0.5, -1.5> look_at <1, 0.4, -1.3> angle 10}  // wall closeup
camera { location <2.5, 1.5, -5> look_at <2.5, 0.4, 0> }  // wall 
